...
entry(
    ...
    group = 
"""
1 *2 [Cd,Cdd,Ct,CO,N,CS]   u0 r1 {2,[D,T]}
2 *3 [Cd,Ct,O2d,S2d,Cdd,N] u0 c0 r1 {1,[D,T]}
""",
    kinetics = None,
)
...
"""
1 *1 R!H                   u1 {2,S}
2 *2 [Cd,Ct,CO,N,CS]       u0 r1 {1,S} {3,[D,T]}
3 *3 [Cd,Ct,O2d,S2d,Cdd,N] u0 c0 r1 {2,[D,T]}
""",
    kinetics = None,
)
...
"""
1 *1 R!H      u1 {2,S}
2 *2 Cd       u0 r1 {1,S} {3,D}
3 *3 [Cd,Cdd] u0 c0 r1 {2,D}
""",
    kinetics = None,
)
...
"""
1 *1 R!H u1 {2,S}
2 *2 CO  u0 r1 {1,S} {3,D}
3 *3 O2d u0 c0 r1 {2,D}
""",
    kinetics = None,
)
...
"""
1 *1 R!H u1 {2,S}
2 *2 CS  u0 r1 {1,S} {3,D}
3 *3 S2d u0 p2 c0 r1 {2,D}
""",
    kinetics = None,
)
...
3 *2 [Cd,Ct,CO,N,CS]       u0 r1 {2,S} {4,[D,T]}
4 *3 [Cd,Ct,O2d,S2d,Cdd,N] u0 c0 r1 {3,[D,T]}
""",
    kinetics = None,
)
...
1 *1 R!H                 u1 {2,S}
2 *4 R!H                 u0 {1,S} {3,S}
3 *2 [Cd,Ct,CO,CS]       u0 r1 {2,S} {4,[D,T]}
4 *3 [Cd,Ct,O2d,S2d,Cdd] u0 c0 r1 {3,[D,T]}
""",
    kinetics = None,
)
...
1 *1 R!H      u1 {2,S}
2 *4 R!H      u0 {1,S} {3,S}
3 *2 Cd       u0 r1 {2,S} {4,D}
4 *3 [Cd,Cdd] u0 c0 r1 {3,D}
""",
    kinetics = None,
)
...
1 *1 R!H u1 {2,S}
2 *4 R!H u0 {1,S} {3,S}
3 *2 CO  u0 r1 {2,S} {4,D}
4 *3 O2d u0 c0 r1 {3,D}
""",
    kinetics = None,
)
...
1 *1 R!H u1 {2,S}
2 *4 R!H u0 {1,S} {3,S}
3 *2 CS  u0 r1 {2,S} {4,D}
4 *3 S2d u0 c0 r1 {3,D}
""",
    kinetics = None,
)
...
4 *2 [Cd,Ct,CO,N,CS]       u0 r1 {3,S} {5,[D,T]}
5 *3 [Cd,Ct,O2d,S2d,Cdd,N] u0 c0 r1 {4,[D,T]}
""",
    kinetics = None,
    longDesc = 
u"""
...
2 *4 R!H      u0 {1,S} {3,S}
3 *5 R!H      u0 {2,S} {4,S}
4 *2 Cd       u0 r1 {3,S} {5,D}
5 *3 [Cd,Cdd] u0 c0 r1 {4,D}
""",
    kinetics = None,
    longDesc = 
u"""
...
2 *4 R!H u0 {1,S} {3,S}
3 *5 R!H u0 {2,S} {4,S}
4 *2 CO  u0 r1 {3,S} {5,D}
5 *3 O2d u0 c0 r1 {4,D}
""",
    kinetics = None,
    longDesc = 
u"""
...
2 *4 R!H u0 {1,S} {3,S}
3 *5 R!H u0 {2,S} {4,S}
4 *2 CS  u0 r1 {3,S} {5,D}
5 *3 S2d u0 c0 r1 {4,D}
""",
    kinetics = None,
)
...
3 *5 R!H                   u0 {2,S} {4,S}
4 *2 [Cd,Ct,CO,N,CS]       u0 r1 {3,S} {5,[D,T]}
5 *3 [Cd,Cdd,Ct,O2d,S2d,N] u0 c0 r1 {4,[D,T]}
""",
    kinetics = None,
    longDesc = 
u"""
...
5 *2 [Cd,Ct,CO,N,CS]       u0 r1 {4,S} {6,[D,T]}
6 *3 [Cd,Ct,O2d,S2d,Cdd,N] u0 c0 r1 {5,[D,T]}
""",
    kinetics = None,
)
...
3 *6 R!H                 u0 {2,S} {4,[S,D,T,B]}
4 *5 R!H                 u0 {3,[S,D,T,B]} {5,S}
5 *2 [Cd,Ct,CO,CS]       u0 r1 {4,S} {6,[D,T]}
6 *3 [Cd,Ct,O2d,S2d,Cdd] u0 c0 r1 {5,[D,T]}
""",
    kinetics = None,
)
...
3 *6 R!H      u0 {2,S} {4,S}
4 *5 R!H      u0 {3,S} {5,S}
5 *2 Cd       u0 r1 {4,S} {6,D}
6 *3 [Cd,Cdd] u0 c0 r1 {5,D}
""",
    kinetics = None,
)
...
3 *6 R!H u0 {2,S} {4,S}
4 *5 R!H u0 {3,S} {5,S}
5 *2 CO  u0 r1 {4,S} {6,D}
6 *3 O2d u0 c0 r1 {5,D}
""",
    kinetics = None,
)
...
3 *6 [Cd,Ct,Cb] u0 {2,S} {4,[D,T,B]}
4 *5 [Cd,Ct,Cb] u0 {3,[D,T,B]} {5,S}
5 *2 CS         u0 r1 {4,S} {6,D}
6 *3 S2d        u0 c0 r1 {5,D}
""",
    kinetics = None,
)
...
5 *2 [Cd,Ct,CO,CS]   u0 r1 {4,S} {6,[D,T]}
6 *3 [Cd,Ct,O2d,S2d] u0 c0 r1 {5,[D,T]}
""",
    kinetics = None,
)
...
6 *2 [Cd,Ct,CO,N,CS]       u0 r1 {5,S} {7,[D,T]}
7 *3 [Cd,Ct,O2d,S2d,Cdd,N] u0 c0 r1 {6,[D,T]}
""",
    kinetics = None,
)
...
7 *2 [Cd,Ct,CO,N,CS]       u0 r1 {6,S} {8,[D,T]}
8 *3 [Cd,Ct,O2d,S2d,Cdd,N] u0 c0 r1 {7,[D,T]}
""",
    kinetics = None,
)
...
8 *2 [Cd,Ct,CO,N,CS]       u0 r1 {7,S} {9,[D,T]}
9 *3 [Cd,Ct,O2d,S2d,Cdd,N] u0 c0 r1 {8,[D,T]}
""",
    kinetics = None,
)
